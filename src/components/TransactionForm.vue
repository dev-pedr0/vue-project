<script>
    ...
    const type = ref<"entrada" | "saída">("entrada");
...
<template>
    <form @submit.prevent="handleSubmit" class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md space-y-4">
        ...
        <div class="flex space-x-4">
            ...
            <label class="flex items-center space-x-2">
                <input type="radio" value="saida" v-model="type" class="accent-red-500" />
                <span>Saída</span>
            </label>
        </div>
